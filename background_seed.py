...
SEARCH_QUERIES = {
    "pov_movement": ("pov walking", "pov driving", "train window", "cycling pov", "walking trail"),
    "city_motion": ("city traffic", "night drive", "urban street", "subway", "pedestrian street"),
    "nature_motion": ("forest trail", "scenic road", "mountain road", "river", "ocean waves"),
    "cleaning": ("car wash", "pressure washing", "dish washing", "detailing"),
    "crafting": ("pottery making", "woodworking", "handmade craft", "artisan process"),
    "food_process": ("food preparation", "chopping food", "cooking closeup", "baking", "coffee making", "tea making"),
    "assembly_process": ("factory assembly", "manufacturing", "machining", "packaging"),
    "satisfying_process": ("satisfying process", "sorting", "printing press", "repetitive machine"),
}
