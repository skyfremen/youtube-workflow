...
class WorkflowTopologyTests(unittest.TestCase):
    ...
    def test_daily_uses_ranked_pool_entrypoint(self):
        ...
        self.assertIn("content/planning-pools/daily/YYYY-MM-DD.json", prompt)

    def test_adhoc_uses_ranked_pool_entrypoint(self):
        ...
        self.assertIn("content/planning-pools/adhoc/ap-<stable-id>.json", prompt)
