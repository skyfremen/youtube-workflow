...
14. After authoring the complete temporary five-candidate pool, execute the exact canonical pre-commit validator:
...
18. Private Ad-hoc Production independently reruns the same pre-commit validation as a committed-pool admission gate before ranked promotion. This is defense in depth only; it does not waive step 17 and it is not the planner execution engine.
