...
The gate requires **all five candidates PASS** before immutable pool commit. `planning.adhoc_precommit` remains only a backward-compatible wrapper and is not required for canonical materialization.
