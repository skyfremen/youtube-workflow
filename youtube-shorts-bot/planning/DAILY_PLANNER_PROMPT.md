...
Repository code/configuration at current `main` remains the source of truth. If older Daily rule text repeats Git/bootstrap/materialization instructions, `PLANNER_PROMPT.md` supersedes only those duplicated execution-environment instructions; the Daily business/creative rules remain mandatory.
