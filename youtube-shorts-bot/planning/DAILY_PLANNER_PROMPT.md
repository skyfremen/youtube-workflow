...
7. After authoring and freezing the complete temporary Daily ranked pool, execute the exact canonical pre-commit validator:
...
11. Private Daily Production independently reruns the same pre-commit validation as a committed-pool admission gate before ranked promotion. This is defense in depth only; it does not waive step 10.
